...
DELETE FROM public.benchmark_run_log WHERE run_month = '2026-07' AND domain = 'hubspot.com/pricing';
DELETE FROM public.scan_results WHERE url_domain = 'hubspot.com';