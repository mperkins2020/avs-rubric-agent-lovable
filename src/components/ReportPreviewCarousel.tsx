...
const lovableExample: ExampleData = {
  ...
  band: "Advanced",
  bandClass: "text-score-high bg-score-high/10 border-score-high/30",
  bandDesc: "Exceptional value system maturity",
  score: 14,
  maxScore: 16,
  percentage: "88%",
  strengths: {
    title: "ICP and job clarity",
    desc: "Lovable clearly defines its target audience, from individual builders to enterprises, and explicitly lists use cases.",
    enables: "Enables: Effective marketing and sales targeting.",
  },
  weaknesses: {
    title: "Product north star",
    desc: "While the primary outcome is stated, there is no explicit predictability metric or target.",
    impact: "Impact: Hard to forecast long-term costs.",
  },
  breakpoints: [
