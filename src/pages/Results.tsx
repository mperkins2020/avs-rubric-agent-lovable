...
import { Sparkles, Loader2, Download, X, Bot } from "lucide-react";
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium rounded-full bg-muted text-muted-foreground border border-border cursor-help">
                    <Bot className="w-3 h-3" aria-hidden="true" />
                    AI-generated
                  </span>
                </TooltipTrigger>
                <TooltipContent className="max-w-xs">
                  This report is generated by AI (Lovable AI Gateway, Google Gemini & OpenAI models) from publicly available information. Scores and rationales may contain errors — review evidence before acting. EU AI Act Art. 50 disclosure.
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
