-- ============================================================
-- AVS Benchmark — get_benchmark_data RPC v2
-- Adds score_delta_pct and prior_total_score_pct to company
-- objects so the dashboard can display all scores as percentages
-- without frontend arithmetic.
--
